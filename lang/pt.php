...
return [
    ...
    "section-welcome-adv-title" => "Por que escolher o Taxi C7? 🤝",
    "section-welcome-adv-1-title" => "Disponibilidade 24/7",
    "section-welcome-adv-1-description" => "Não importa a hora, estamos aqui para você.",
    "section-welcome-adv-2-title" => "Um motorista particular independente",
    "section-welcome-adv-2-description" => "Um serviço personalizado e sem estresse.",
    "section-welcome-adv-3-title" => "Viagens confortáveis e seguras",
    "section-welcome-adv-3-description" => "Veículo bem mantido, condução suave e agradável.",
    "section-welcome-adv-4-title" => "Transfers para estações de trem e aeroportos",
    "section-welcome-adv-4-description" => "Lausanne, Genebra, Zurique, Bulle, Palézieux… cuidamos de tudo!",

    "section-welcome-adv-5-title" => "Flexibilidade e discrição",
    "section-welcome-adv-5-description" => "Para suas viagens de negócios, privadas ou turísticas.",

    "section-welcome-adv-6-title" => "Reserva simples e rápida",
    "section-welcome-adv-6-description" => "Uma chamada, uma mensagem e seu motorista está a caminho!",

    "section-welcome-end" => "Precisa de um táxi agora ou mais tarde? Entre em contato agora e viaje com tranquilidade!",

    "section-welcome-construction" => "Este site ainda está em construção, mais informações estarão disponíveis em breve... Fique atento.",
];