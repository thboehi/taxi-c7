...
return [
    ...
    "section-welcome-adv-title" => "Why choose Taxi C7? 🤝",

    "section-welcome-adv-1-title" => "24/7 Availability",
    "section-welcome-adv-1-description" => "No matter the time, we are here for you.",

    "section-welcome-adv-2-title" => "An independent private driver",
    "section-welcome-adv-2-description" => "A personalized, stress-free service.",

    "section-welcome-adv-3-title" => "Comfortable and safe journeys",
    "section-welcome-adv-3-description" => "Well-maintained vehicle, smooth and pleasant driving.",

    "section-welcome-adv-4-title" => "Transfers to train stations and airports",
    "section-welcome-adv-4-description" => "Lausanne, Geneva, Zurich, Bulle, Palézieux… we take care of everything!",

    "section-welcome-adv-5-title" => "Flexibility and discretion",
    "section-welcome-adv-5-description" => "For your business, private, or tourist trips.",

    "section-welcome-adv-6-title" => "Simple and fast booking",
    "section-welcome-adv-6-description" => "A call, a message, and your driver is on the way!",

    "section-welcome-end" => "Need a taxi now or later? Contact us now and enjoy a hassle-free ride!",

    "section-welcome-construction" => "This site is still under construction, more information will be available soon... Stay tuned."
];