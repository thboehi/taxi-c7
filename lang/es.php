...
return [
    ...
    "section-welcome-adv-title" => "¿Por qué elegir Taxi C7? 🤝",
    "section-welcome-adv-1-title" => "Disponibilidad 24/7",
    "section-welcome-adv-1-description" => "No importa la hora, estamos aquí para ti.",
    "section-welcome-adv-2-title" => "Un chófer privado independiente",
    "section-welcome-adv-2-description" => "Un servicio personalizado y sin estrés.",
    "section-welcome-adv-3-title" => "Viajes cómodos y seguros",
    "section-welcome-adv-3-description" => "Vehículo bien mantenido, conducción suave y agradable.",
    "section-welcome-adv-4-title" => "Traslados a estaciones de tren y aeropuertos",
    "section-welcome-adv-4-description" => "Lausana, Ginebra, Zúrich, Bulle, Palézieux… ¡nos encargamos de todo!",

    "section-welcome-adv-5-title" => "Flexibilidad y discreción",
    "section-welcome-adv-5-description" => "Para tus viajes de negocios, privados o turísticos.",

    "section-welcome-adv-6-title" => "Reserva rápida y sencilla",
    "section-welcome-adv-6-description" => "¡Una llamada, un mensaje y tu conductor está en camino!",

    "section-welcome-end" => "¿Necesitas un taxi ahora o más tarde? ¡Contáctanos ahora y disfruta de un viaje sin preocupaciones!",

    "section-welcome-construction" => "Este sitio aún está en construcción, pronto habrá más información... ¡Mantente atento!",
